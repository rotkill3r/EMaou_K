      ...
      body: JSON.stringify({
        ...
        html: `
          <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;max-width:560px;margin:0 auto;font-family:Arial,Helvetica,sans-serif;background:#ffffff;border-radius:8px;overflow:hidden">
            <tr>
              <td style="background:#0A0E1A;padding:24px 24px 20px;text-align:center">
            ...
            <tr>
              <td style="padding:12px 24px 4px">
                ...
                <a href="${site_url || ''}" style="color:#D4AF37;text-decoration:underline;font-size:15px;line-height:1.5;font-weight:500;word-break:break-all">${site_url || '—'}</a>
              </td>
            </tr>
            <tr><td style="padding:0 24px"><hr style="border:0;border-top:1px solid #eee;margin:0"></td></tr>
            <tr>
              <td style="padding:12px 24px 4px">
                ...
                <span style="color:#555;font-size:15px;line-height:1.6;white-space:pre-wrap">${(message || '').trim() || '—'}</span>
              </td>
            </tr>
            <tr><td style="padding:0 24px"><hr style="border:0;border-top:1px solid #eee;margin:0"></td></tr>
            <tr>
            ...
            <tr>
              <td style="padding:20px 24px;text-align:center;background:#f5f5f5;border-top:1px solid #eee">
      ...
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;max-width:560px;margin:0 auto;font-family:Arial,Helvetica,sans-serif;background:#ffffff;border-radius:8px;overflow:hidden">
            ...
            <tr>
              <td style="padding:24px 24px 8px;font-family:Arial,Helvetica,sans-serif;color:#333;font-size:15px;line-height:1.7">
                Hola <strong style="color:#1a1a1a">${name.trim()}</strong>,
              </td>
            </tr>
            <tr>
              <td style="padding:8px 24px;font-family:Arial,Helvetica,sans-serif;color:#555;font-size:15px;line-height:1.7">
            ...
            <tr>
              <td style="padding:8px 24px 16px;font-family:Arial,Helvetica,sans-serif;color:#555;font-size:15px;line-height:1.7">
                ...
                <table role="presentation" style="width:100%;background:#fafafa;border-radius:6px;border:1px solid #eee">
                  <tr>
                    <td style="padding:16px 20px">
                      <span style="color:#D4AF37;font-size:10px;font-weight:700;letter-spacing:1.2px;text-transform:uppercase">Sitio web</span><br>
                      <span style="color:#333;font-size:14px">${site_url || '—'}</span>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td style="padding:16px 20px">
                      ...
                      <span style="color:#555;font-size:14px;line-height:1.5">${(message || '').trim() || '—'}</span>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td style="padding:20px 24px 8px;font-family:Arial,Helvetica,sans-serif;color:#555;font-size:15px;line-height:1.7">
                Saludos cordiales,
              </td>
            </tr>
            <tr>
              <td style="padding:0 24px;font-family:Georgia,serif;color:#D4AF37;font-size:15px;font-weight:700">
                Equipo Seb_PROYECT
              </td>
            </tr>
            <tr>
              <td style="padding:0 24px 24px;font-family:Arial,Helvetica,sans-serif;color:#888;font-size:12px">
